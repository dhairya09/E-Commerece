...
public class SideMenu extends AppCompatActivity implements FragDrawer.FragmentDrawerListener {

    private Toolbar mToolbar;
    //private FragmentDrawer drawerFragment;
    private FragDrawer drawerFragment;
